...
public class Money implements Comparable {
	...
	public Money add(Money other) {
		int otherAmountInThisCurrency = other.currency.valueInThisCurrency(other.amount, this.currency);
	...
	/* some tests in Bank/Account tests failed due to bad comparison with object equal method, so here's an override */
	@Override
